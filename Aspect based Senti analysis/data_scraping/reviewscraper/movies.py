...
#    if os.path.exists("/home/ubuntu/Aspect-Based-Sentiment-Analysis/Aspect based Senti analysis/data_scraping/reviewscraper/data/flipkart/"+fileflipkart+".json"):
#        os.system("rm /home/ubuntu/Aspect-Based-Sentiment-Analysis/Aspect based Senti analysis/data_scraping/reviewscraper/data/flipkart/"+fileflipkart+".json")
    print "step 5"
    ...
    #check if the file already exists
#    if os.path.exists("/home/ubuntu/Aspect-Based-Sentiment-Analysis/Aspect based Senti analysis/data_scraping/reviewscraper/data/amazon/"+fileamazon+".json"):
#        os.system("rm /home/ubuntu/Aspect-Based-Sentiment-Analysis/Aspect based Senti analysis/data_scraping/reviewscraper/data/amazon/"+fileamazon+".json")
    print "step 10"
